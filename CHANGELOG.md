...
- **Rejeição por veto nas sugestões**: basta uma pessoa marcar "Não curti" ou "✕ Não faz sentido" pra sugestão contar como rejeitada e sair de "Em aberto". O card continua mostrando quem votou o quê, e as opiniões seguem abertas — quem quiser defender a música ainda pode votar
